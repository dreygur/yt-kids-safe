...
import com.ytkidssafe.ui.viewmodel.ChannelVideosViewModel

@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun KidChannelVideosScreen(
    profileId: String,
    channelId: String,
    onVideoClick: (String) -> Unit,
    onBack: () -> Unit,
    viewModel: ChannelVideosViewModel = hiltViewModel()
) {
    ...
    Scaffold(
        ...
        topBar = {
            TopAppBar(
                title = { Text(channel?.title ?: "Videos") },
                navigationIcon = {
